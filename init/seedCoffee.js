...
const coffeeVarieties = [
  ...
  {
    varietyName: 'Taiwan Arabica',
    varietyName_zh: '台灣阿拉比卡',
    imageUrl: 'https://images.unsplash.com/photo-1586095516671-d085ff58cdd4?q=80&w=1287&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    optimalElevationMin: 800,
    optimalElevationMax: 1500,
    tempDifferentialMin: 7,
    ...
    cupQualityMin: 78,
    cupQualityMax: 85,
    harvestMonths: 'November to January',
    processingMethods: ['washed', 'honey', 'natural'],
    flavorNotes_en: 'Mild sweetness with notes of caramel, red fruit and light citrus',
    flavorNotes_zh: '溫和甜味，帶有焦糖、紅色水果與淡淡柑橘香氣',
    qualityTips_en: 'Adaptable, locally-selected Arabica lineage grown widely in Alishan and Gukeng. Performs reliably at 800-1500m with moderate disease pressure. Good entry point for new Taiwan growers.',
    qualityTips_zh: '適應性強、經本地選育的阿拉比卡品系，廣泛種植於阿里山與古坑。在800-1500公尺表現穩定，病害壓力中等。適合台灣新手農友入門種植。',
    yieldPerTree: 2.2,
    treesPerHectare: 1300,
    yearsToFirstHarvest: 3,
    productiveYears: 25
  },
  {
    varietyName: 'Ethiopian Heirloom',
    varietyName_zh: '衣索比亞原生種',
    imageUrl: 'https://images.unsplash.com/photo-1710752213640-aa9ed91a8646?q=80&w=1287&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    optimalElevationMin: 1500,
    optimalElevationMax: 2200,
    tempDifferentialMin: 10,
    diseaseResistance: 'high',
    cupQualityMin: 84,
    cupQualityMax: 92,
    harvestMonths: 'December to February',
    processingMethods: ['washed', 'natural', 'honey'],
    flavorNotes_en: 'Wild floral aromatics, bergamot, stone fruit and a delicate tea-like body',
    flavorNotes_zh: '狂野花香、佛手柑、核果與細緻如茶般的口感',
    qualityTips_en: 'Genetically diverse landrace population rather than a single cultivar. Naturally resilient to alpine cold stress and disease. Yields vary tree-to-tree; plant in mixed stands rather than uniform blocks.',
    qualityTips_zh: '遺傳多樣性高的原生種群，並非單一品種。天生能耐受高山寒冷壓力與病害。各株產量不一致，建議混植而非單一區塊種植。',
    yieldPerTree: 1.3,
    treesPerHectare: 1100,
    yearsToFirstHarvest: 4,
    productiveYears: 30
  ...
  {
    varietyName: 'Wush Wush',
    varietyName_zh: '烏什烏什',
    imageUrl: 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?q=80&w=1287&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    optimalElevationMin: 1800,
    optimalElevationMax: 2200,
    tempDifferentialMin: 10,
    diseaseResistance: 'medium',
    cupQualityMin: 85,
    cupQualityMax: 93,
    harvestMonths: 'January to March',
    processingMethods: ['washed', 'natural', 'honey', 'anaerobic'],
    flavorNotes_en: 'Intensely floral and fruity, jasmine, peach and a honey-like sweetness',
    flavorNotes_zh: '極度花香果味，茉莉、水蜜桃與蜂蜜般甜味',
    qualityTips_en: 'Rare Ethiopian landrace, prized alongside Geisha for cup quality. Requires ultra-high elevation and careful shade management to express its full floral profile. Low, inconsistent yields but commands top specialty prices.',
    qualityTips_zh: '罕見的衣索比亞原生種，與藝妓齊名，杯測品質極受推崇。需要超高海拔與細緻遮蔭管理才能展現完整花香特性。產量低且不穩定，但可獲得頂級精品價格。',
    yieldPerTree: 1.1,
    treesPerHectare: 900,
    yearsToFirstHarvest: 4,
    productiveYears: 22
